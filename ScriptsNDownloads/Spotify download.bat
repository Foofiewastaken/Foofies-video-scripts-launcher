...
yt-dlp "!YTURL!" --cookies "D:\YT video downloader\music.youtube.com_cookies.txt" -o "Music\%%(artist)s\%%(title)s.%%(ext)s" --extract-audio --audio-format mp3 --embed-thumbnail -v
